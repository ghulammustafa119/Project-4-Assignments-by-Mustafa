...
# There arg times where we want to return different things from a function based on some condition. To practice this idea, imagine that we want to check if someone is an adult. We might check their age and return different things depending on how old they are!
...
def main():
    age = int(input("How old is this person?: "))  # Corrected here: age should be an integer
    print(is_adult(age))
